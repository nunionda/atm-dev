...
def _serialize_metrics(metrics: Any) -> Dict[str, Any]:
    ...
    m["phase_stats"] = {
        ...
        "es2a_tp1_partial": ps.es2a_tp1_partial,
        "es2b_tp2_partial": ps.es2b_tp2_partial,
        # Phase F: Holding-Tier 분류
        "tier_LONG_entries": ps.tier_LONG_entries,
        "tier_MID_entries": ps.tier_MID_entries,
        "tier_SHORT_entries": ps.tier_SHORT_entries,
        "es2a_tier_LONG": ps.es2a_tier_LONG,
        "es2a_tier_MID": ps.es2a_tier_MID,
        "es2a_tier_SHORT": ps.es2a_tier_SHORT,
