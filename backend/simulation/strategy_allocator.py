"""
StrategyAllocator — 멀티 전략 모드용 전략별 자본 배분 관리자.

레짐 기반 비중 할당, 가상 예산 분리, Kelly 스칼라, 상관 행렬 등.

Phase 4.C 분할: ats/simulation/engine.py → ats/simulation/strategy_allocator.py
"""
