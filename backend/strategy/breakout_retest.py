        ...
        for pos in positions:
            ...
            if atr_val is not None and atr_val > 0:
                ...
                if current_price >= atr_tp_price:
                    # Phase B: Rebalance HOLD/BUY 종목이면 BRT TP만 skip, 트레일링은 fall through
                    if self.exit_guard and self.exit_guard.is_es2_protected(pos, self.market_id)[0]:
                        logger.info("ES_BRT_TP_SKIPPED_PROTECTED | %s | pnl=+%.2f%%",
