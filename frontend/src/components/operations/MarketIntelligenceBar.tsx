...
// K5: 6+3레짐 추세 컬러 매핑 (3키 추가 + 6키 backward compat)
const TREND_COLORS: Record<IndexTrend, { bg: string; border: string; text: string }> = {
    ...
    RANGE_BOUND: { bg: 'rgba(234,179,8,0.10)', border: 'rgba(234,179,8,0.3)', text: '#eab308' },
    ...
    // 3-key (K5)
    BULL_AGG:    { bg: 'rgba(34,197,94,0.15)', border: 'rgba(34,197,94,0.4)', text: '#22c55e' },
    BEAR_AGG:    { bg: 'rgba(239,68,68,0.15)', border: 'rgba(239,68,68,0.4)', text: '#ef4444' },
};

const TREND_LABELS: Record<IndexTrend, string> = {
    // 6-key legacy
    STRONG_BULL: '강한상승', BULL: '상승', NEUTRAL: '중립',
    RANGE_BOUND: '박스권', BEAR: '하락', CRISIS: '위기',
    // 3-key (K5) — 단순화 표시
    BULL_AGG: '강세', BEAR_AGG: '약세',
};
