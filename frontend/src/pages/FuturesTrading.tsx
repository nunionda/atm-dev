...
import { type DataMode } from '@hooks/useFuturesScalp';

// Phase 3.C extracted sub-components
import { getTickerCurrency, formatPrice, formatPnL } from '@components/futures-trading/currency';
import { LayerScoreBar }          from '@components/futures-trading/LayerScoreBar';
import { ZScoreGauge }            from '@components/futures-trading/ZScoreGauge';
import { MetricCard }             from '@components/futures-trading/MetricCard';
import { MonteCarloDistribution } from '@components/futures-trading/MonteCarloDistribution';
import { ExitReasonBreakdown }    from '@components/futures-trading/ExitReasonBreakdown';
import { FuturesPriceChart }      from '@components/futures-trading/FuturesPriceChart';
import { ScalpDecisionEngine }    from '@components/futures-trading/ScalpDecisionEngine';
